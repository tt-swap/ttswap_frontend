...
const TokenInvestSelector = ({ value, onChange, isValue }: Props) => {
          ...
          a.tokens[index].children[index1].title = (
            <>
              ...
              <span className="magL">
                ...
                <span>investQuantity:{prettifyCurrencys(el1.investQuantity)}</span>
                <span>feeQuantity:{prettifyCurrencys(el1.feeQuantity)}</span>
                <span>investFee:{(el1.investFee * 100).toFixed(2)}%</span>
                <span>disinvestFee:{(el1.disinvestFee * 100).toFixed(2)}%</span>
              </span>
            </>);
  ...
  return (
    <>
      <TokenInvestModal open={open} setOpen={setOpen} title={"Select a token"}>
